<div class="section-dashboard section-dashboard-networking">
    <div class="section-dashboard-title flex flex-between">
        ...
        <div class="a-progress-bar" data-form="add_contact_form">
            <div class="a-progress-bar-percent inter fw-medium fz-012"><span class="count">0</span>% <span>done</span>
            </div>
            <div class="progress">
    ...
    <div class="section-dashboard-content flex flow-column">
        <div class="content-item">
            <form id="add_contact_form" class="progress-tracking submit-disabled"
                  action="{{ route('user.contacts.store') }}" method="POST">
                @csrf
                <div class="a-form__section">
                    <div class="a-form__item">
                        ...
                        <div class="a-form__item-box">
                            ...
                            <input class="a-input a-input-brand @error('contact_method') is-invalid @enderror"
                                   id="contact_method" name="contact_method" value="{{ old('contact_method') }}"
                                   type="text"
                    ...
                    <div class="a-form__item">
                        ...
                        <div class="a-form__item-box">
                            <label for="conversation_topic" class="a-form__item__label">Topic of
                                Conversation</label>
                            <input
                                class="a-input a-input-brand addable @error('conversation_topic.0') is-invalid @enderror"
                                id="conversation_topic" name="conversation_topic[]"
                                value="{{ old('conversation_topic.0') }}" type="text"
                            ...
                            @if(old('conversation_topic'))
                                @foreach(old('conversation_topic') as $topic)
                                    ...
                                    <div class="multiple-input-deletable">
                                        <input class="a-input a-input-brand addable deletable"
                                               name="conversation_topic[]" value="{{ $topic }}"
                                               type="text"
                                               placeholder="Enter topic of conversation...">
                            ...
                            <button type="button"
                                    class="a-form__item-box__add-more flex align-center add-input input-has-name no-need-new-index">
                                Add New
                            ...
                            <template>
                                <div class="multiple-input-deletable">
                                    <input class="a-input a-input-brand addable deletable" name="conversation_topic[]"
                                           value=""
                                           type="text"
                                           placeholder="Enter topic of conversation...">
                                    <span class="delete"></span>
                    ...
                    <div class="a-form__item">
                        ...
                        <div class="a-form__item-box">
                            <label for="advice_or_feedback" class="a-form__item__label">Specific Advice or Feedback
                                Received</label>
                            <input
                                class="a-input a-input-brand addable @error('advice_or_feedback.0') is-invalid @enderror"
                                id="advice_or_feedback" name="advice_or_feedback[]"
                                value="{{ old('advice_or_feedback.0') }}" type="text"
                            ...
                            @if(old('advice_or_feedback'))
                                @foreach(old('advice_or_feedback') as $advice)
                                    ...
                                    <div class="multiple-input-deletable">
                                        <input class="a-input a-input-brand addable deletable"
                                               name="conversation_topic[]" value="{{ $advice }}"
                                               type="text"
                                               placeholder="Enter topic of conversation...">
                                        @error("conversation_topic.$loop->index")
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <template>
                                <div class="multiple-input-deletable">
                                    <input class="a-input a-input-brand addable deletable" name="advice_or_feedback[]"
                                           value=""
                                           type="text"
                                           placeholder="Enter specific advice or feedback Received...">
                                    <span class="delete"></span>
                    ...
                    <div class="a-form__item">
                        ...
                        <div class="a-form__item-box">
                            ...
                            <input
                                class="a-input a-input-brand addable @error('interests_or_hobbies.0') is-invalid @enderror"
                                id="interests_or_hobbies" name="interests_or_hobbies[]"
                                value="{{ old('interests_or_hobbies.0') }}" type="text"
                            ...
                            @if(old('interests_or_hobbies'))
                                @foreach(old('interests_or_hobbies') as $interest)
                                    ...
                                    <div class="multiple-input-deletable">
                                        <input class="a-input a-input-brand addable deletable"
                                               name="conversation_topic[]" value="{{ $interest }}"
                                               type="text"
                                               placeholder="Enter topic of conversation...">
                                        @error("conversation_topic.$loop->index")
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <template>
                                <div class="multiple-input-deletable">
                                    <input class="a-input a-input-brand addable deletable" name="interests_or_hobbies[]"
                                           value=""
                                           type="text"
                                           placeholder="Enter interests or hobbies...">
                                    <span class="delete"></span>
                    ...
                    <div class="a-form__item">
                        <div class="a-form__item-box">
                            ...
                            <input class="a-input a-input-brand @error('mutual_connection') is-invalid @enderror"
                                   id="mutual_connection" name="mutual_connection"
                                   value="{{ old('mutual_connection') }}" type="text"
                        ...
                        <div class="a-form__item-box">
                            ...
                            <div class="dropdown">
                                <button
                                    class="dropdown__button @if(old('status')) select-active @endif @error('status') is-invalid @enderror"
                                    type="button">{{ \App\Models\Contact::ALL_STATUSES[old('status')] ?? 'Choose status...' }}</button>
                                @error('status')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <ul class="dropdown__list">
                                    @foreach(\App\Models\Contact::ALL_STATUSES as $id => $status)
                                        <li class="dropdown__list-item @if(old('status') == $id) dropdown__list-item_active @endif"
                                            data-value="{{ $id }}">{{ $status }}</li>
                                    @endforeach
                                    <input class="dropdown__input_hidden" type="text" name="status"
                                           value="{{ old('status') }}">
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="a-form__item">
                        <div class="a-form__item-box">
                            ...
                            <div class="dropdown">
                                <button
                                    class="dropdown__button @if(old('type')) select-active @endif @error('type') is-invalid @enderror"
                                    type="button">{{ \App\Models\Contact::ALL_TYPES[old('type')] ?? 'Choose type...' }}</button>
                                @error('type')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                @enderror
                                <ul class="dropdown__list">
                                    @foreach(\App\Models\Contact::ALL_TYPES as $id => $type)
                                        <li class="dropdown__list-item @if(old('type') == $id) dropdown__list-item_active @endif"
                                            data-value="{{ $id }}">{{ $type }}</li>
                                    @endforeach
                                    <input class="dropdown__input_hidden" type="text" name="type"
                                           value="{{ old('type') }}">
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="a-form__item">
                        <div class="a-form__item-box">
                            ...
                            <input class="a-input a-input-brand @error('contact_details.phone') is-invalid @enderror"
                                   id="contact_details_phone" name="contact_details[phone]"
                                   value="{{ old('contact_details.phone') }}" type="text"
                            ...
                            <input class="a-input a-input-brand @error('contact_details.email') is-invalid @enderror"
                                   id="contact_details_email" name="contact_details[email]"
                            ...
                            @if(old('contact_details'))
                                @foreach(old('contact_details') as $i => $contact_detail)
                                    ...
                                    <div class="multiple-input-deletable">
                                        <input
                                            class="a-input a-input-brand  @error('contact_details.'.$i) is-invalid @enderror deletable"
                            ...
                            <template>
                                <div class="multiple-input-deletable">
                                    <input class="a-input a-input-brand deletable" name="" value="" type="text"
                                           placeholder="Enter...">
                                    <span class="delete"></span>
                                </div>
                            </template>
