        ...
        <div class="login-section-wrapper">
            <div class="login-section-box">
                ...
                <form action="{{ route('password.update') }}" method="POST">
                    ...
                    <input class="a-input @error('email') is-invalid @enderror" name="email" type="email" id="email" placeholder="Work Email *" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus required>
                    @error('email')
                    ...
                    <div class="a-input-eye">
                        <input name="password" required="" id="newPassword" class="a-input a-input-password @error('password') is-invalid @enderror" type="password"
                    ...
                    <div class="a-input-eye">
                        <input name="password_confirmation" required="" id="confirmPassword" class="a-input a-input-password"
                    ...
                    <div class="login-section-buttons flex align-center">
                        <button type="submit" class="btn btn-black fz-024">Reset Password</button>
                    </div>
                </form>
            </div>
        </div>
